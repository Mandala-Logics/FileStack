...
namespace MandalaLogics.Database
{
    ...
    {
        internal class CordKeyEnumerator : IEnumerator<TKey>
        {
            public TKey Current { get; private set; } = null!;
            ...
            public CordKeyEnumerator(Cord<TKey, TValue> owner)
            {
                _owner = owner;
